...
static PAINTSTRUCT ps,pss;
static string windowTitle = "Window";
...
/*    RegisterWindowClass();*/
	...
	wndcls.hIcon = (HICON)LoadImage(NULL,"./source/minesweeper.ico",IMAGE_ICON,0,0, LR_DEFAULTSIZE | LR_LOADFROMFILE);
